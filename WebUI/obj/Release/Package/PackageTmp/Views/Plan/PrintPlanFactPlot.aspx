...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        Telerik.Reporting.ReportSource report = new Reports.PlanFactPlot();
        report.Parameters.Add(new Telerik.Reporting.Parameter("GroupID", Model.GroupID));
        report.Parameters.Add(new Telerik.Reporting.Parameter("Date", Model.Date));
        //report.ReportParameters["DocumentID"].Value = Model;
